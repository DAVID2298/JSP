...
public class HospitalRegistryDAO implements DAO<HospitalRegistry> {
    ...
    public boolean insert(HospitalRegistry hospitalRegistry) {
        ...
        try {
            ...
            preparedStatement.setInt(7, hospitalRegistry.getUser_id());
    ...
    @Override
    public HospitalRegistry read(int id) {
        Connection connection = ConnectionSingleton.getInstance();
        try {
    ...
    public boolean update(HospitalRegistry userRegistryToUpdate) {
        ...
        if (!userRegistryRead.equals(userRegistryToUpdate)) {
            try {
                ...
                preparedStatement.setInt(7, userRegistryToUpdate.getUser_id());
