        ...
        <div class="profile-wrapper">
            ...
            <div class="prof-wrapper">
                ...
                <div class="wrapper-btn">
                    ...
                    <button type="button" onclick="toServletd()" class="btnDel">ELIMINA</button>
...
<script>
    ...
    function toServlet(){
        window.location.href = "UserRegistryServlet?mode=readuser&updatem=true&id=<%=u.getUserId()%>";
    }
</script>
<script>

    function toServletd(){
        window.location.href = "UserRegistryServlet?mode=delete&id=<%=u.getUserId()%>";
    }
</script>
</html>